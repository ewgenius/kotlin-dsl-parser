...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "Block", "symbols": ["BlockName", "_", {"literal":"("}, "_", "Arguments", "_", {"literal":")"}], "postprocess": d => ({ name: d[0], type: "function", arguments: d[4] })},
    {"name": "BlockName", "symbols": ["String"], "postprocess": id},
    {"name": "BlockName", "symbols": ["Identifier"], "postprocess": id},
    {"name": "BlockName", "symbols": ["Identifier", "_", {"literal":"("}, "_", "String", "_", {"literal":")"}], "postprocess": d => d[4]},
    ...
    {"name": "Function", "symbols": ["BlockName", "_", {"literal":"("}, "_", "Arguments", "_", {"literal":")"}], "postprocess": d => ({ name: d[0], type: "function", arguments: d[4] })},
